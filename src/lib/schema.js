...
export default class BaseSchema {
  ...
  clone(spec) {
    ...
    next.spec = cloneDeep(Object.assign(Object.assign({}, this.spec), spec))
    return next
  }
  label(label) {
    var next = this.clone()
  ...
  validate(value, options, maybeCb) {
    let schema = this.resolve(
      Object.assign(Object.assign({}, options), { value })
    )
  ...
  validateSync(value, options) {
    ...
    schema._validate(
      value,
      Object.assign(Object.assign({}, options), { sync: true }),
      (err, value) => {
        if (err) throw err
        result = value
      }
...
for (const method of ['validate', 'validateSync'])
  BaseSchema.prototype[`${method}At`] = function (path, value, options = {}) {
    ...
    return schema[method](
      ...
      Object.assign(Object.assign({}, options), { parent, path })
    )
  }
